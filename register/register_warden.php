...
<body>
    <div class="container-fluid bg_img">
        <center>
            <p class="login_text">Register Warden Portal</p>
        </center>
        <form action="warden_validate.php" method="post">
            <div>
            ...
            <div>
                ...
                <input type="text" id="uname" placeholder="user Id" name="userid" required>
            </div>
            <div>
