...
<body>
    <div class="container-fluid bg_img">
        <center>
            <p class="login_text">Complaint Registration Portal</p>
        </center>
        <form action="comp_register_back.php" method="post" enctype="multipart/form-data">
            <div>
                <label for="name">Complaint in Details : </label>
                
                <textarea rows="5" id="name" placeholder="Max char 100" name="comp" required></textarea>
            </div>
            <div>
                <label for="phone">Photo (optional): </label>
